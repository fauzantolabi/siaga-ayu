    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Program</h3>
                <p class="text-subtitle text-muted">Daftar Program Yang Telah Ditambahkan</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <a href="{{route('program.create')}}" class="btn btn-primary float-start float-lg-end">
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('program.destroy', $program->id) }}" method="POST" class="d-inline">
                        @csrf @method('DELETE')
                        <button class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus program ini?')">Hapus</button>
                    </form>
                </td>
            </tr>
            @endforeach
